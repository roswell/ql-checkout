...
(defmethod vcs-init ((vcs (eql 'latest-github-release)) params)
  (make-instance vcs :uri (first params)))
(defmethod vcs-init ((vcs (eql 'latest-github-tag)) params)
  (make-instance vcs :uri (first params)))
...
(defmethod vcs-init ((vcs (eql 'ediware-http)) params)
  (make-instance vcs :uri (format nil "https://github.com/edicl/~A.git" (first params))))
